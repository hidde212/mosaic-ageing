...
//Global variables
unsigned popSize = 5000;			/// (Initial) generation size
double intDeathRate = 0.5;		    /// Chance to die (lower is higher survivability); intrinsic death rate.
double extDeathRate = 0.0;		    /// Fraction individuals who die each timestep, extrinsic death
...
int skip = 1;                      /// To write output data at every $skip generations
