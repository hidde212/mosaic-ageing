...
double mutRateGen1 = 0.01;   // Rate of mutation for gen 1
double mutRateGen2 = 0.01;   // Rate of mutation for gen 2
double mutRateGen3 = 0.05;   // Rate of mutation for gen 3
double mutRateGen4 = 0.05;   // Rate of mutation for gen 4

double mutStdDev = 0.5;      // Standard deviation for mutation
double mutStdDevGen1 = 0.5;  // Standard deviation for mutation in gen 1
double mutStdDevGen2 = 0.5;  // Standard deviation for mutation in gen 2
double mutStdDevGen3 = 0.5;  // Standard deviation for mutation in gen 3
double mutStdDevGen4 = 0.5;  // Standard deviation for mutation in gen 4